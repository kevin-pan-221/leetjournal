...
export const api = {
  ...
  updateBook: (bookId:string,input:CreateBookInput) => invoke('update_problem_book',{bookId,input}),
  importBookProblems: (bookId:string,input:ImportBookProblemsInput) => invoke<ImportBookProblemsResult>('import_book_problems',{bookId,input}),
  removeBookProblem: (bookId:string,problemId:string) => invoke('remove_book_problem',{bookId,problemId}),
